    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="47.45" stroke="#cccccc" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="5"/>',
                ...
                '<circle class="progress-bar" cx="50" cy="50" r="47.45" stroke="#ffcc8e" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#000000" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="40" y1="35" x2="40" y2="65" stroke="#ffcc8e" fill="none" stroke-width="7" stroke-linecap="round"/>',
                '<line x1="60" y1="35" x2="60" y2="65" stroke="#ffcc8e" fill="none" stroke-width="7" stroke-linecap="round"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="45,35 65,50 45,65" fill="#ffcc8e" stroke-width="0"></polygon>',
                '</g>',
